...
class AccountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post account_types_url, params: { account_type: { kind: @account_type.kind, name: @account_type.name, user_id: @account_type.user_id } }, as: :json
    end
  ...
  test "should update account_type" do
    patch account_type_url(@account_type), params: { account_type: { kind: @account_type.kind, name: @account_type.name, user_id: @account_type.user_id } }, as: :json
    assert_response 200
  end
